...
export const appContent: Record<AppLocale, {
  ...
  ptBR: {
    ...
    home: {
      ...
      roadmapDescription:
        "A estrutura foi separada para manter o trabalho de produto organizado: dashboard, perfil público, modelo de dados e integrações com Supabase já estão prontos para a próxima fase.",
    ...
    dashboard: {
      ...
      profilePublishedDescription: "Seu perfil público já pode ser acessado em /u/{username}.",
      ...
      publicCardDescriptionDraft: "Ative a publicação do perfil para transformar seu perfil em um link público para divulgação.",
      publicCardUrlLabel: "URL pública",
      publicCardOpen: "Abrir perfil público",
      ...
      onboardingSteps: {
        ...
        publish: "Ativar o perfil público",
      },
      discovery: {
        label: "Rede",
      ...
      linkRemove: "Remover",
      linkNew: "Novo link",
      linkInactiveHint: "Desative para esconder este botão do perfil público.",
